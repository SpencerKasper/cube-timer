...
export function StatValue(props: { onLabelClick?: () => void; statistic: Statistic; overrideLabelInStat?: string; overrideDescriptionInStat?: string; placementOfDescription?: "bottom-end" | "bottom-start" | "bottom" | "left-end" | "left-start" | "left" | "right-end" | "right-start" | "right" | "top-end" | "top-start" | "top" }) {
    ...
    return <div className='stat' style={{...(props.onLabelClick && {cursor: 'pointer'})}} onClick={() => {
